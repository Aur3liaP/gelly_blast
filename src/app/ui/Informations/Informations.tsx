...
export default function Informations() {
  return (
    <div className="pt-18 flex flex-col-reverse lg:flex-row lg:w-[90%] mx-auto justify-around items-center gap-8">
      <Carrousel />
      <div className="w-4/5 max-w-90 md:w-3/5 lg:w-1/3 bg-yellow rounded-2xl min-h-80 p-8">
        <h3 className="font-medium text-2xl 2xs:text-3xl mb-8">
          C&apos;est quoi <br />
